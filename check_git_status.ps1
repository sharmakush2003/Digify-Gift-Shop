# Dedicated Git Status & Sync Script for Digify-Gift-Shop
# Target GitHub Repository: https://github.com/sharmakush2003/Digify-Gift-Shop.git

$projectName = "Digify-Gift-Shop"
$targetRemote = "https://github.com/sharmakush2003/Digify-Gift-Shop.git"
